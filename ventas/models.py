...
class Venta(models.Model):
    ...
    # ── Montos (regla de los tres campos) ──
    ...
    def calcular_totales(self, porcentaje_iva=16):
        ...
        self.iva_bs   = (self.subtotal_bs * Decimal(str(porcentaje_iva)) / 100
    ...
    def __str__(self):
        return f"{self.numero_factura} — {self.fecha} ({self.get_estado_display()})"
